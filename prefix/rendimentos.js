...
module.exports = {
    ...
    run: async(client, message, args) => {
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField(`<:relogio:1115838051856437390> **・Hoje:**`, `<:cart:1089319551981850835>・Pedidos: ${hojepedidos || "0"} \n<:carteira:1115827529559842876>・Recebimentos: R$${hojerecebimentos || "0"}`, false)
        .addField(`**<:relogio:1115838051856437390>・Ultimos 7 dias:**`, `<:cart:1089319551981850835>・Pedidos: ${setedias || "0"} \n<:carteira:1115827529559842876>・Recebimentos: R$${setediasrec || "0"}`, false)
        .addField(`**<:relogio:1115838051856437390>・Ultimos 30 dias:**`, `<:cart:1089319551981850835>・Pedidos: ${setedias2 || "0"} \n<:carteira:1115827529559842876>・Recebimentos: R$${setediasrec2 || "0"}`, false)
