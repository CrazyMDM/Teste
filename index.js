...
titulo = titulo.replace("#{nome}", `${config.get(`title`)}`);
        ...
        interaction.message.edit({ embeds: [embed], components: [row] })
          ...
          const embedsemstock = new Discord.MessageEmbed()
            .setDescription(`<a:notif:1115828282013790281>・Este produto está sem estoque, aguarde um reabastecimento!`)
            .setColor("RED")
            ...
            if (quantidade < 1) {
              ...
              .setColor("RED")
              .setDescription(`**<a:notif:1115828282013790281>・O estoque do produto \`\`${interaction.customId}\`\` Acabou e tem gente querendo comprar!\n\nProduto: \`\`${eprod.nome}\`\`**`)
          ...
          new Discord.MessageActionRow()
            .addComponents(
              new Discord.MessageButton()
                ...
                .setEmoji('<a:notif:1115828282013790281>')
                .setStyle("SECONDARY")
                .setDisabled(true)
       ...
       if ((interaction.guild.channels.cache.find(c => c.topic === interaction.user.id))) {
          return interaction.followUp({
              embeds: [
                  new Discord.MessageEmbed()
                      .setColor("RED")
                      .setDescription(`**<a:no:1115828260920635392>・Você já tem um produto no carrinho!**`)
              ],
              ephemeral: true
          })
      }
        ...
        interaction.guild.channels.create(`🛒・carrinho-${interaction.user.username}`, {
          ...
          const irparacarrinho = new Discord.MessageEmbed()
            .setColor(`GREEN`)
            .setDescription(
              `<a:planeta:1115828269774819348>・Seu carrinho foi criado em ( ${c} )`
            );
          ...
          .setColor(db.get(`${interaction.customId}.color`))
           ...
           const embedsstermos = new Discord.MessageEmbed()
             .setColor(db.get(`${interaction.customId}.color`))
             .setDescription(`<a:planeta:1115828269774819348>・Olá <@${interaction.user.id}>, este é seu carrinho, fique á vontade para adicionar mais produtos ou fazer as modificações que achar necessário.\n\n<:nuvem:1136836890809614386>・Você pode abaixar os dados dessa compra apertando no botão abaixo\n\n**<a:sim:1115828258676678747>・Continuar:** Quando estiver tudo pronto aperte o botão abaixo, apertando ele você estará concordando com todos os termos no canal: <#1109636972261150730>, e estará continuando com sua compra!`)
             .setFooter({ text: `${config.get(`title`)} - Todos os direitos reservados.` })
...
const embedentrega = new Discord.MessageEmbed()
                   ...
                   const cancelado = new Discord.MessageEmbed()
                        .setColor("RED")
                        .setDescription(`<a:no:1115828260920635392> **・O membro ${interaction.user.username}** (${interaction.user.id}) **fechou o carrinho do produto que ele tentou comprar:** ${eprod.nome} `)
...
fs.writeFile(dd, dadosUTF, (err) => {
  ...
  interaction.user.send(`<a:load:1117290048388354158>・<@${interaction.user.id}> Gerando seus dados UTF-8...`)
  ...
  interaction.user.send({ embeds: [content], files: [attachment] });
                 ...
                 if (quantidade <= quantidade1) {
                   ...
                   const embedss2 = new Discord.MessageEmbed()
                     ...
                     .setDescription(`\`\`\`Escolha uma forma de pagamento.\`\`\`\n**<a:planeta:1115828269774819348>・Produto:** \`${eprod.nome}\`\n**<:caixa:1115828666048450631>・Produtos no Carrinho:** \`${quantidade1}\`\n**<:dinheiro:1115831821918289921>・Valor:** \`R$${precoalt} Reais\``)
                     .setColor(db.get(`${interaction.customId}.color`))
                     .setThumbnail(client.user.displayAvatarURL())
            ...
            msg.edit({ components: [row, rowa] })
                   ...
                   if (intera.customId === "comprarboton") {
                       ...
                       const aberto = new Discord.MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`<a:sim:1115828258676678747> **・O membro ${interaction.user.username}** (${interaction.user.id}) **abriu o carrinho do produto:** ${eprod.nome} `)
                    ...
                    dbP.set(`pay.nome`, `Mercado Pago`)
                     ...
                     const embedss = new Discord.MessageEmbed()
                     .setDescription(`**<a:planeta:1115828269774819348>・Produto:** \`${eprod.nome}\`\n**<:dinheiro:1115831821918289921>・Valor Unitário:** \`R$${db.get(`${interaction.customId}.preco`).toLocaleString()}\`\n**<:caixa:1115828666048450631>・Produtos no Carrinho:** \`${quantidade1}\`\n**<:carteira:1115827529559842876>・Valor Total:** \`R$${precoalt}\`\n**<:cupom:1115828278620606515>・Cupom:** \`Nenhum\``)                                     
                     .setColor(db.get(`${interaction.customId}.color`))
                       .setThumbnail(client.user.displayAvatarURL())
                       ...
                       collector.on("collect", intera2 => {
                         ...
                         if (intera2.customId === 'addcboton') {
                           intera.channel.permissionOverwrites.edit(intera.user.id, { SEND_MESSAGES: true });
                            msg.channel.send(`<:info:1109637008189571174>・Digite o seu cupom:`).then(mensagem => {
                             ...
                             collector.on("collect", cupom => {
                               if(`${cupom}` !== `${dbc.get(`${cupom}.idcupom`)}`) {
                                 cupom.delete()
                                 mensagem.edit(`<a:no:1115828260920635392>・Esse cupom não existe.`)
                               ...
                               if(precoalt < minalt) {
                                 cupom.delete()
                                 intera.channel.permissionOverwrites.edit(intera.user.id, { SEND_MESSAGES: false });
                                 mensagem.edit(`<a:no:1115828260920635392>・Você não atingiu o mínimo!`)
                                 return;
                               } else {
                               ...
                               if(`${dbc.get(`${cupom}.quantidade`)}` === "0") {
                                 cupom.delete()
                                 intera.channel.permissionOverwrites.edit(intera.user.id, { SEND_MESSAGES: false });
                                 mensagem.edit(`<a:no:1115828260920635392>・Esse cupom saiu de estoque!`)
                                 return;
                               }
                               ...
                               if(`${cupom}` === `${dbc.get(`${cupom}.idcupom`)}`) {
                                 ...
                                 mensagem.edit(`<a:sim:1115828258676678747>・Cupom adicionado`)
                                  intera.channel.permissionOverwrites.edit(intera.user.id, { SEND_MESSAGES: false });
                           ...
                           if (intera2.customId === "continuarboton") {
                             ...
                             msg.channel.send(`<a:load:1117290048388354158> **・Gerando Pagamento com dados UTF-8...**`)
                                 ...
                                 clearInterval(venda);
                                  const vendadel = setTimeout(function () {
                                   ...
                                   const canalif1 = client.channels.cache.get(config.canallogs);
                                     ...
                                     if (a < quantidade1) {
                                       db3.set(`${data_id}.status`, `Reembolsado`)
                                       msg.channel.send(`<a:sim:1115828258676678747>・Pagamento reembolsado`)
                                       msg.channel.send(`<a:sim:1115828258676678747>・ID Da compra: ${data_id}`)
                                        mercadopago.configure({ access_token: `${config.get(`access_token`)}` });
                                         var refund = { payment_id: `${data.body.id}` };
                                          mercadopago.refund.create(refund).then(result => {
...
fs.writeFile(textFileName, word, (err) => {
    ...
    const attachment = new Discord.MessageAttachment(textFileName);
                    ...
                    const sls = setTimeout(function () {
                                ...
                                interaction.user.send("<:caixa:1115828666048450631>**・Entrega do Produto:**")
                                   interaction.user.send(`${removed.join("\n")}`)}, 5000)
                        
                                              db3.set(`${data_id}.status`, `Concluido`)
                                              msg.channel.send(`<a:sim:1115828258676678747>・Pagamento aprovado!`)
            ...
            const embedava = new Discord.MessageEmbed()
                                               ...
                                               .addField(`<:info:1109637008189571174>・Informações:`, `Escolha uma nota essa venda.`)
            ...
            c.send({ embeds: [embedava], components: [rowavaliacao] })}, 1000)
                                            ...
                                            if (reem === null) reem = false;
                                               ...
                                               const message2 = await canalif.send({ embeds: [new Discord.MessageEmbed()
                                                 .setDescription(`**<:github:1109637063009116270>・Comprador:** ${interaction.user.tag} (${interaction.user.id})\n**<a:planeta:1115828269774819348>・Produto(s) Comprado(s):** \`\`${eprod.nome}\`\`\n**<:caixa:1115828666048450631>・Quantidade Comprada:** \`${quantidade1}\`\n**<:dinheiro:1115831821918289921>・Valor Pago:** \`\`R$${precoalt}\`\`\n**📆・Data da compra:** ${moment().format('LLLL')}\n**<:mysql:1109636930599125012>・ID da compra:** \`\`${data_id}\`\`\n**<:mysql:1109636930599125012>・ID reembolso:** \`\`${data.body.id}\`\`\n**Cupom usado** ${dbc.get(`usado`)}\n**${dbP.get(`pay.emoji`)}・Forma de Pagamento:** ${dbP.get(`pay.nome`)}`)
                                               ...
                                               const interação = message2.createMessageComponentCollector({ componentType: "BUTTON", })
                                                interação.on("collect", async (interaction) => {
                                                 if (interaction.customId === "reembolso") {
                                                   ...
                                                   if (interaction.user.id !== `${perms.get(`${user}_id`)}`) return interaction.reply({ content: `<a:no:1115828260920635392>・Você não está na lista de pessoas!`, ephemeral: true })
                                                   interaction.deferUpdate()
                                                     mercadopago.configure({ access_token: `${config.get(`access_token`)}` });
                                                      var refund = { payment_id: `${data.body.id}` };
                                                       mercadopago.refund.create(refund).then(result => {
...
titulo = titulo.replace("#{nome}", `${config.get(`title`)}`);
                         ...
                         .setThumbnail(client.user.displayAvatarURL())
                                 ...
                                 const embed = new Discord.MessageEmbed()
                                                         .setFooter(`ID da compra: ${data_id}`)
                                                         .setDescription(`\`\`\`Escolha uma forma de pagamento.\`\`\`\n> **<a:planeta:1115828269774819348>・Produto:**, \`${eprod.nome}\`\n**<:caixa:1115828666048450631>・Quantidade:** \`${quantidade1}\`\n> **<:dinheiro:1115831821918289921>・Valor:** \`R$${precoalt}\`\n**<:relogio:1115838051856437390>・Pagamento Expira em:** <t:${unixTimestamp}:f> (<t:${unixTimestamp}:R>)`)
                                                         .setColor(db.get(`${interaction.customId}.color`))
                                                         .setThumbnail("https://cdn.discordapp.com/attachments/1109637133888671795/1135913769403424809/LogoQuinteira.png")
             ...
             interaction.channel.send({ embeds: [embed] }).then(msg => {
              ...
              const collector = msg.channel.createMessageCollector({ filter});               collector.on("collect", yTRASHER => {
                 ...
                 .setTitle(`${config.get(`title`)}・Sistema de avaliação`)
                 .setColor("GREEN")
                 .setDescription(`<a:sim:1115828258676678747>・Obrigado pela mensagem avaliativa \`${dbV.get('mensagem')}\``)
                 ...
                 interaction.channel.send({ content: `Utilize \`${config.get(`prefix`)}fechar\` para deletar o carrinho.` })
                                                        ...
                                                        dbV.set(`avaliacao`, `⭐ (1)`)
                                                        interaction.channel.send(`<a:sim:1115828258676678747> **・Obrigado pela sua avaliação, envie sua mensagem avaliativa pelo botão abaixo!** `)
...
let result = num1 - num2;
                                ...
                                dbS.set(`${interaction.user.id}.saldo`, result)
                                    ...
                                    db3.set(`${data_id}.status`, `Processando`)
                                                        interaction.reply(`<a:sim:1115828258676678747> **・Pagamento pago por saldo com sucesso!.** `)
                                                        
        dbP.set(`pay.emoji`, `<:carteira:1115827529559842876>`)
...
const ve = setTimeout(function () {
                          ...
                          interaction.channel.send({content: `<a:no:1115828260920635392>・Pagamento não encontrado.`})
           }, 8000)
                                                       }
        ...
        dbP.set(`pay.nome`, `Pago por Cartão`)
                                                        interaction.reply({content: `<a:sim:1115828258676678747> **・Pagamento validado com sucesso (aguarde 5s).** `, ephemeral: true})
                                                       }
  ...
  if (interaction.customId === 'n') {
      ...
      interaction.channel.send(`<a:no:1115828260920635392>・Você ainda não pagou!`)
  }
                ...
                .setColor('RED')
                       ...
                       if (interaction.customId === 'aviss') {
                        ...
                        .setDescription(`<a:notif:1115828282013790281> **・O membro ${interaction.user.username}** (${interaction.user.id}) **avisou que esta sem estoque do produto:** ${eprod.nome} `)
                   ...
                   if (intera.customId === "comprarboton") {
                    ...
                    dbP.set(`pay.nome`, `Mercado Pago`)
                     ...
                     const embedss = new Discord.MessageEmbed()
                       ...
                       .setDescription(`<a:planeta:1115828269774819348>・Produto: \`${eprod.nome}\`\n<:carteira:1115827529559842876>・Valor Unitário: \`R$$${db.get(`${interaction.customId}.preco`)}\`\n<:caixa:1115828666048450631>・Quantidade: \`${quantidade1}\`\n<:carteira:1115827529559842876>・Total : \`R$${precoalt}\`\n\n\n<:carrinho:1116836145897164820>・Produtos no Carrinho: \`${quantidade1}\`\n<:carteira:1115827529559842876>・Valor a pagar: \`R$${precoalt}\`\n<:cupom:1115828278620606515>・Cupom: \`Nenhum\``)
                       .setColor(db.get(`${interaction.customId}.color`))
                       .setThumbnail(client.user.displayAvatarURL())
                     c.send({ embeds: [embedss], components: [row], content: `<@${interaction.user.id}>`, fetchReply: true }).then(msg => {
                       const filter = i => i.user.id === interaction.user.id;
...
fs.writeFile(textFileName, word, (err) => {
    ...
    .addField(`<:carrinho:1116836145897164820> **・Produto(s) Comprado(s):**`, `${eprod.nome}`)
